...
<head>
    ...
    <title>CondoY | @yield('title')</title>
    <!-- Favicon-->
    ...
    <link href="{{ asset('admin/assets') }}/plugins/nouislider/nouislider.min.css" rel="stylesheet" />
...
<body class="theme-grey">
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                <div class="image">
                    <img src="{{ asset('admin/assets') }}/images/user.png" width="48" height="48"
                        alt="User" />
                </div>
                ...
                <ul class="list">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                                <a href="{{ route('salesteams.create') }}">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="{{ route('floorplans.index') }}">
                                    <span>Floorplans</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('floorplans.create') }}">
                                    <span>Create Floorplan</span>
                                </a>
                            </li>
                        </ul>
                    </li>
